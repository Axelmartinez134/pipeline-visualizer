  ...
  selectProcess(processId) {
    ...
    if (this.thoughtBubbles) {
      ...
      if (processId !== 'overview') {
        // ========================================
        // AUDIT PAGE MODIFICATION: DISABLE THOUGHT BUBBLES
        // ========================================
        // Thought bubbles are disabled for the audit page
        // We only show the bottom educational overlay (bottleneck priorities)
        // Original code that showed thought bubbles:
        // setTimeout(() => {
        //   this.thoughtBubbles.showBubble(processId);
        // }, 2000);
        console.log('[Audit] Thought bubbles disabled for process:', processId);
        // ========================================
      }
    } else {
